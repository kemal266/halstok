        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../netting/islem.php"method="POST">
              ...
              <div>
                <input type="text" name="kullanici_mail" class="form-control" placeholder="Kullanıcı Adı" required="" />
              </div>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-apple"></i> Hal Stok Sistemi</h1>
                  <p>©2020 Kemal Tokmak Tarafından yazılmıştır...</p>
                </div>
              </div>
            </form>
          </section>
