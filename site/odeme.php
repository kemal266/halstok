			...
			<tbody>
				...
				while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
					...
					<tr>
						...
						<td><form><?php echo $uruncek['firma_id'] ?></form></td>
...
<input type="radio" name="siparis_banka" value="<?php echo $bankacek['banka_ad'] ?>">
						<?php echo $bankacek['banka_ad']; echo " ";?>
						<?php echo $bankacek['banka_iban']; echo " ";?><br>
					...
					<input type="hidden" name="firma_id" value="<?php echo $uruncek['firma_id'] ?>">
