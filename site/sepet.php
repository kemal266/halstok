			...
			<tbody>
				...
				while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
					...
					<tr>
						...
						<td><?php                                                        
						$adcek = $db->query("select firma_ad from firma where firma_id=" . $uruncek['firma_id'])->fetch();
						echo $adcek['firma_ad']; 
						?>	</td>
						<td><?php echo $uruncek['urun_id'] ?></td>
						<td><form><input type="text" class="form-control quantity" value="<?php echo $sepetcek['urun_adet'] ?>"></form></td>
						<td><?php echo $uruncek['urun_fiyat'] ?></td>
						<td><center><a href="../neadmin/netting/islem.php?sepet_id=<?php echo $sepetcek['sepet_id']; ?>&sepetsil=ok"><button class="btn btn-danger btn-xs">Kaldır</button></a></center></td>
